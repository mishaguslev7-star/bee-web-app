...
# --- ШАПКА И ЗАГОЛОВОК ---
# Используем стилистику презентации
st.markdown("""
...
with col_title:
    ...
    Нейросеть превращает хаотичное движение пчел в ценные данные, помогая вовремя заметить экологическую угрозу.
    </p>
    """, unsafe_allow_html=True)
with col_logo:
    # Можно вставить логотип, но оставим стилизованную подпись
    st.markdown("""
...
with col_upload:
    st.markdown("### 📸 Загрузите изображение рамки")
    file = st.file_uploader("Выберите фото", type=['jpg', 'jpeg', 'png'], label_visibility="collapsed")
...
if file:
    ...
    with st.spinner('🧠 Искусственный интеллект анализирует снимок...'):
        ...
        # Отображение результата с боксами
    ...
    with col_res:
        ...
        # Кнопка "Понятный результат" как в концепции
        st.download_button(
...
# --- НИЖНЯЯ ЧАСТЬ: О ПРОЕКТЕ (Скопировано из презентации) ---
